...
const ProductCart = () => {
  ...
  const handleCheckout = async () => {
    const response = await fetch("/api1/stripe-session/", {
      method: "POST",
    ...
    if (data.session) {
      ...
      toast.loading('Redirecting to Stripe...'); // Display loader toast
    ...
    <main className="mt-20">
      <Wrapper>
        ...
        <div className="flex lg:flex-row flex-col gap-10 mt-10">
          ...
          <div className="bg-[#fbfcff] flex-1 flex flex-col p-8 g-8">
